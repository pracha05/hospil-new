					...
					<div style="padding:20px;">
						...
						<div class=" row ">
							<div class=" col-md-12 ">
								...
								<div class="form-group col-md-6">
									<label class="col-lg-4 control-label">Free  days </label>
									<div class="col-md-8">
									<input type="text" class="form-control" name="shopname" placeholder="Enter Free  days" />
									</div>
								</div>
								<div class="form-group col-md-6">
									<label class="col-lg-4 control-label">No of visits</label>
									<div class="col-md-8">
									<input type="text" class="form-control" name="shopname" placeholder="No of visits" />
									</div>
								</div>
								<div class="form-group col-md-6">
									<label class="col-lg-4 control-label">Special fee</label>
									<div class="col-md-8">
									<input type="text" class="form-control" name="shopname" placeholder="Special fee" />
									</div>
								</div>
								<div class="form-group col-md-6">
								...
								<div class="form-group col-md-6">
									...
									<div class="col-md-8">
									<input type="text" class="form-control" name="shopname" placeholder="Ip consultation fee" />
									</div>
								</div>
								<div class="form-group col-md-6">
