						...
						<div class=" row ">
							<div class=" col-md-12 ">
								 <div class="form-group col-md-6">
									...
									<div class="col-md-8">
										<input type="text" class="form-control" name="shopname" placeholder="Enter investigation name" />
									</div>
								</div> 
								<div class="form-group col-md-6">
									<label class="col-lg-4 control-label">Test Code</label>
									<div class="col-md-8">
										<input type="text" class="form-control" name="shopname" placeholder="Enter Test Code" />
									</div>
								</div>
								<div class="form-group col-md-6">
									...
									<div class="col-md-8">
									<input type="number" class="form-control" name="shopname" placeholder="Enter No of days" />
									</div>
								</div>
								<div class="form-group col-md-6">
								...
								<div class="form-group col-md-6">
									...
									<div class="col-md-8">
									<input type="text" class="form-control" name="shopname" placeholder="print name" />
									</div>
								</div>
								<div class="form-group col-md-6">
									<label class="col-lg-4 control-label">Machine</label>
									<div class="col-md-8">
									<select class="form-control">
								...
								<div class="form-group col-md-6">
									<label class="col-lg-4 control-label">Patience Procedure</label>
									<div class="col-md-8">
									<textarea class="form-control"></textarea>
									</div>
								</div>
								<div class="form-group col-md-6">
									<label class="col-lg-4 control-label">Lab Procedure</label>
									<div class="col-md-8">
									<textarea class="form-control"></textarea>
									</div>
								</div>
						...
						<div class="clearfix">&nbsp;</div>
							...
							<div class="form-group">
								<div class="col-lg-12 text-center">
									...
									<button type="submit" class="btn btn-primary  " name="signup" value="Sign up">Add Investigation</button>
								</div>
							</div>
						</form>
