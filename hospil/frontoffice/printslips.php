						...
						<div class=" row ">
							<div class=" col-md-6">
								<div class="form-group">
									<label class="col-lg-4 control-label">Lab No</label>
									<div class="col-md-8">
							<input type="text" class="form-control" name="shopname" placeholder="Enter Lab No" />
									</div>
								</div> 
								<div class="form-group ">
									...
									<label class="radio-inline">
										  <input type="radio" name="optradio" checked>Refunds
										</label>
										<label class="radio-inline">
										  <input type="radio" name="optradio">Cancellations
										</label>
										<label class="radio-inline">
										  <input type="radio" name="optradio">Payments
										</label>
									</div>
								</div>
								<div class="form-group ">
