	...
	<section class="content-header mb-4">
       ...
       Shift Collection
		...
		<ol class="breadcrumb">
			...
			<li class="active">Shift Collection</li>
		</ol>
	</section>
									...
									<div class="form-group ">
										...
										<div class="col-md-8">
											<label class="checkbox-inline">
												<input type="checkbox" value="">Check all</label>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-4 control-label">&nbsp;</label>
										<div class="col-md-8">
											<div class="row checkbox_typessection">
												<label class=" col-md-4">
													<input type="checkbox" value="">Op Consultation</label>
												<label class=" col-md-4">
													<input type="checkbox" value="">Op Procedure</label>
												<label class=" col-md-4">
													<input type="checkbox" value="">Lab</label>
												<label class=" col-md-4">
													<input type="checkbox" value="">Ip Admission</label>
												<label class=" col-md-4">
													<input type="checkbox" value="">Ip Procedure</label>
												<label class=" col-md-4">
													<input type="checkbox" value="">Ip Operation</label>
												<label class=" col-md-4">
													<input type="checkbox" value="">Other Charges</label>
												<label class=" col-md-4">
													<input type="checkbox" value="">Misc charges</label>
												<label class=" col-md-4">
													<input type="checkbox" value="">Equipment charges</label>
												<label class=" col-md-4">
													<input type="checkbox" value="">FNB chargers</label>
											</div>
										</div>
									</div>
								</div>
