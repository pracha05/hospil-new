					...
					<div style="padding:20px;">
						...
						<div class=" row ">
							<div class=" col-md-12 ">
								...
								<div class="form-group col-md-6">
									<label class="col-lg-4 control-label">Lab Id</label>
									<div class="col-md-8">
										<input type="text" class="form-control" name="shopname" placeholder="Enter Lab id" />
									</div>
								</div>
								<div class="form-group col-md-6">
								...
								<div class="form-group col-md-6">
									<label class="col-lg-4 control-label">Payment Mode</label>
									<div class="col-md-8">
									<select class="form-control">
											<option>cash</option>
											<option>card</option>
