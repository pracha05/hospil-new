						...
						<form id="defaultForm" method="post" class="form-horizontal" action="">
							<div class=" row ">
								...
								<div class=" col-md-6 ">
									<div class="form-group ">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="shopname" placeholder="Enter Manufacturer name" />
										</div>
									</div>
									<div class="form-group ">
							...
							<div class="form-group">
								<div class="col-lg-6 text-center">
									<button type="submit" class="btn btn-primary  " name="signup" value="Sign up">Add Manufacturer</button>
								</div>
							</div>
						</form>
						<div class="clearfix">&nbsp;</div>
