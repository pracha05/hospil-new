					...
					<div style="padding:20px;">
						...
						<div class=" row ">
							<div class=" col-md-6 ">
								...
								<div class="form-group ">
									<label class="col-lg-4 control-label">Facilities</label>
									<div class="col-md-8">
						...
						<div class="clearfix">&nbsp;</div>
							...
							<div class="form-group">
								<div class="col-lg-6 text-center">
									...
									<button type="submit" class="btn btn-primary  " name="signup" value="Sign up">Add Room</button>
								</div>
							</div>
						</form>
