			...
			<div class="col-md-12">
				...
				<div class=" ">
                  ...
                  <input type="text" class="form-control pull-right datepicker" >
								...
								<div class="form-group col-md-6">
									<label class="col-lg-4 control-label">Floor No</label>
									<div class="col-md-8">
										<input type="text" class="form-control" name="shopname" placeholder="Enter Floor No" />
									</div>
								</div>
								<div class="form-group col-md-6">
									<label class="col-lg-4 control-label">Room No</label>
									<div class="col-md-8">
										<input type="text" class="form-control" name="shopname" placeholder="Enter Room No" />
									</div>
								</div>
								<div class="form-group col-md-6">
									<label class="col-lg-4 control-label">Bed No</label>
									<div class="col-md-8">
										<input type="text" class="form-control" name="shopname" placeholder="Enter Bed No" />
									</div>
								</div>
								<div class="form-group col-md-6">
						...
						<div class=" col-md-12 " style="border-top:2px solid #333;padding-top:10px;">
								...
								<div class="form-group col-md-6">
									<label class="col-lg-4 control-label">Usage Type</label>
									<div class="col-md-8">
									<select class="form-control">
											<option>Type</option>
											<option>Type</option>
                  ...
                  <input type="text" class="form-control pull-right datepicker" >
								...
								<div class="form-group col-md-6">
									<label class="col-lg-4 control-label">Begin Time</label>
