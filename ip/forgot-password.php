...
<body class="login-page login-bg">
	<div class="login-box  ">
		<div class="login-logo"> <a href="#"><b style="color:#227af7;">Hospil</b></a>
		</div>
		<!-- /.login-logo -->
		<div class="login-box-body">
			...
			<form action="../../index2.html" method="post">
				...
				<div class="row">
					<!-- /.col -->
					<div class="col-xs-4"> <a href="dashboard.php" type="submit" class="btn btn-primary btn-block btn-flat">Send</a>
					</div>
					<!-- /.col -->
				</div>
			</form>
