...
<div class="content-wrapper">
	...
	Operation master
		...
		<ol class="breadcrumb">
			...
			<li class="active">Operation master </li>
		</ol>
	</section>
						...
						<div class=" row ">
							<div class=" col-md-6 ">
								 ...
								 <div class="form-group ">
									<label class="col-lg-4 control-label">Operation Name</label>
									<div class="col-md-8">
										<input type="text" class="form-control" placeholder="Enter Operation Name">
									</div>
								</div> 
								<div class="form-group ">
								...
								<div class="form-group ">
									<label class="col-lg-4 control-label">Operation Charges</label>
									<div class="col-md-8">
										<input type="text" class="form-control" placeholder="Enter Operation Charges">
									</div>
								</div>
						...
						<div class="clearfix">&nbsp;</div>
							...
							<div class="form-group">
								<div class="col-lg-6 text-center">
									...
									<button type="submit" class="btn btn-primary  " name="signup" value="Sign up">Add Operation Master</button>
								</div>
							</div>
						</form>
