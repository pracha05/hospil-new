	...
	<section class="content-header mb-4">
      ...
      Referral Doctor
		...
		<ol class="breadcrumb">
			...
			<li class="active">Referral Doctor</li>
		</ol>
	</section>
						...
						<div class=" row ">
							<div class=" col-md-6 ">
								 <div class="form-group ">
									<label class="col-lg-4 control-label">Referral Doctor name</label>
									<div class="col-md-8">
						...
						<div class="clearfix">&nbsp;</div>
							...
							<div class="form-group">
								<div class="col-lg-6 text-center">
									...
									<button type="submit" class="btn btn-primary  " name="signup" value="Sign up">Add Referral Doctor</button>
								</div>
							</div>
						</form>
