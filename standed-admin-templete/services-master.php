	...
	<section class="content-header mb-4">
     ...
     Services Master
		...
		<ol class="breadcrumb">
			...
			<li class="active">services Master</li>
		</ol>
	</section>
					...
					<div style="padding:20px;">
						...
						<div class=" row ">
							<div class=" col-md-6 ">
								...
								<div class="form-group ">
									<label class="col-lg-4 control-label">Service code</label>
									<div class="col-md-8">
								...
								<div class="form-group ">
									<label class="col-lg-4 control-label">Service rate</label>
									<div class="col-md-8">
										<input type="text" class="form-control" placeholder="Enter Service rate">
									</div>
								</div> 
								<div class="form-group ">
						...
						<div class="clearfix">&nbsp;</div>
							...
							<div class="form-group">
								<div class="col-lg-6 text-center">
									...
									<button type="submit" class="btn btn-primary  " name="signup" value="Sign up">Add Service</button>
								</div>
							</div>
						</form>
