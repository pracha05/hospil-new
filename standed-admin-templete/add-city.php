							 ...
							 <table class="table table-bordered table-hover" id="tab_logic">
								...
								<tbody>
									<tr id='addr0'>
										...
										<div class="">
											<input type="text" class="form-control" name="shopname" placeholder="Enter City name" />
											</div>
										</div>
...
<!-- /.row -->
     ...
     $("#add_row").click(function(){
      $('#addr'+i).html("<td>"+ (i+1) +"</td><td><div class='form-group col-md-12'><div class=''><input name='user"+i+"' type='text' placeholder='Enter City Name' class='form-control input-md mt-2'  /></div></div> </td>");
